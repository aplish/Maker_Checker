...
function viewRecord()
{
document.fom.action="MviewAllRecords.jsp?val=perm";
document.fom.submit();
}
function searchRecord()
{
document.fom.action="MviewAllRecords.jsp?val=search";
document.fom.submit();
}
function viewRequests()
{
document.fom.action="MviewAllRecords.jsp?val=temp";
document.fom.submit();
}
</script>
...
<input type="button" value="View Requests Made" onclick="viewRequests();">
<input type="button" value="Search Records" onclick="searchRecord();">
</form>

<form id="searchBC" name="searchBC" action="MviewAllRecords.jsp?val=search" method="post">
